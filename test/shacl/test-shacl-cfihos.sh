pyshacl -d data-examples/example-CFIHOS.ttl  -s CFIHOS/cfihos-shapes-astrea.ttl -e CFIHOS/cfihos-shapes-astrea.ttl --inference rdfs -o CFIHOS/report-example-CFIHOS-astrea.txt
...
pyshacl -d data-examples/example-CFIHOS.ttl  -s CFIHOS/cfihos-shapes-data.ttl -e CFIHOS/cfihos-shapes-data.ttl --inference rdfs -o CFIHOS/report-example-CFIHOS-data.txt
