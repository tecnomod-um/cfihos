pyshacl -d data-examples/example-B.ttl  -s CFIHOS-IDO/cfihos-ido-shapes-astrea.ttl -e CFIHOS-IDO/cfihos-ido-shapes-astrea.ttl --inference rdfs -o CFIHOS-IDO/report-example-B-astrea.txt
...
pyshacl -d data-examples/example-B.ttl  -s CFIHOS-IDO/cfihos-ido-shapes-data.ttl -e CFIHOS-IDO/cfihos-ido-shapes-data.ttl --inference rdfs -o CFIHOS-IDO/report-example-B-data.txt
